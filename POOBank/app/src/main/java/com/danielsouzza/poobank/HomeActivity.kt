...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // User current
        account = controller.getUserCurrent()
    ...
    private fun showDataAccount() {
        viewName.text = getString(R.string.name_current_user, account.getHolder().getName())
        viewBalance.text = getString(R.string.text_balance, account.getBalance().toString())
    }
}